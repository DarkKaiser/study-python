...
def overlay(image, x, y, w, h, overlay_image): # 대상 이미지 (3채널), x, y 좌표, width 절반값, height 절반값, 덮어씌울 이미지 (4채널)
    # 아래 alpha, mask_image는 리스트임!!!
    # mask_image에는 0~1 사이의 값(소수점 포함)이 들어있음
